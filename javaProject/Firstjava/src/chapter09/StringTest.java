...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.concat(" JAVA!!!s"));
		...
		// 문자열의 사이즈 체크 : isDmpty() => str.length() == 0
		...
		System.out.println(str.replace('~', '!')); // 문자와 문자열을 치환 ~ -> !
		System.out.println(str.replace("Hello", "JAVA")); // Hello -> JAVA
