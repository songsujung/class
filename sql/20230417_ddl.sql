...
-- 테이블의 변경
-- alter table [ add, modify, drop cloumn] ()
...
desc emp01;
insert into emp01 values (1111, 'KING', 'MANAGER', 500, 'K', 70); -- 위배
insert into emp01 values (1111, 'KING', 'MANAGER', 1500, 'F', 40); -- O
...
desc emp01;
insert into emp01 values (null, 'KING', 'MANAGER', 1500, 'F', 40, sysdate);
