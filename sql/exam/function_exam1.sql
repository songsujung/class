...
select sysdate,
        to_date('2023-01-01'),
        trunc(sysdate - to_date('2023-01-01', 'YYYY-MM-DD')) as diffDate
from dual;
...
--22. DECODE 함수로 직급에 따라 급여를 인상하도록 하시오. 직급이 ‘ANALYST'인 사원은 200, ‘SALESMAN’인 사원은 180, ‘MANAGER’인 사원은 150, ‘CLERK”인 사원은 100을 인상하시오.
